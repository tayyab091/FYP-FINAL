...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  { id: 'nutrition_pro', label: 'Nutrition Pro', desc: 'Log meals for 7 consecutive days.', icon: Target },
  ...
  { id: 'trainer_connected', label: 'Connected', desc: 'Connect with a verified trainer.', icon: Users },
]
